...
window.onload = () => {
    sota.barChart({
        selector: "#module-general-class-d3",
    ...
    sota.barChart({
        selector: "#module-general-parentsCollege-d3",
    ...
    sota.barChart({
        selector: "#module-general-gender-d3",
    ...
    sota.barChart({
        selector: "#module-general-sexualOrientation-d3",
    ...
    sota.stackedBarChart({
        selector: "#module-general-sexOr-gender-d3",
    ...
    sota.barChart({
        selector: "#module-general-romantic-d3",
    ...
    sota.barChart({
        selector: "#module-general-religion-d3",
    ...
    sota.stackedBarChart({
        selector: "#module-general-temperament-d3",
        dataFile: "assets/data/general/temperament",
        labelStyle: "onBar",
        showLegend: true
    })
    ...
    sota.stackedBarChart({
        selector: "#module-general-socioeconomicXincome-d3",
    ...
    sota.stackedBarChart({
        selector: "#module-general-legacy-income-d3",
    ...
    sota.stackedBarChart({
        selector: "#module-general-varsity-income-d3",
        dataFile: "assets/data/general/varsityXincome",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: true
    })
...
// POLITICS AND WORLDVIEW
    sota.pieChart({
        selector: "#module-politics-affiliation-d3",
        dataFile: "assets/data/politics/political_affiliation"
    });

    sota.barChart({
        selector: "#module-politics-news_sources-d3",
    ...
    sota.pieChart({
        selector: "#module-politics-affirmative_action-d3",
        dataFile: "assets/data/politics/affirmative_action"
    });

    sota.stackedBarChart({
        selector: "#module-politics-reverse_racism-d3",
        dataFile: "assets/data/politics/reverse_racism",
        labelStyle: "onBar",
        showLegend: true
    });
    ...
    sota.stackedBarChart({
        selector: "#module-politics-womens_rights-d3",
        dataFile: "assets/data/politics/womens_rights",
        labelStyle: "onBar",
        showLegend: true
    });

    sota.stackedBarChart({
        selector: "#module-politics-feminist-d3",
    ...
    sota.stackedBarChart({
        selector: "#module-politics-politicsXgender-d3",
    ...
    sota.stackedBarChart({
        selector: "#module-politics-politicsXleadership-d3",
        dataFile: "assets/data/politics/politicsXleadership",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: true
    });
    ...
    sota.stackedBarChart({
        ...
        dataFile: "assets/data/politics/politics_old/news_sourcesXpolitics",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: true
    });
    ...
    sota.columnChart({
        selector: "#module-politics-top_5_news_sources-d3",
        dataFile: "assets/data/politics/top_5_news_sources",
        totalResp: 1031
    });

    sota.stackedColumnChart({
        selector: "#module-politics-affirmative_actionXclass-d3",
        dataFile: "assets/data/politics/affirmative_actionXclass"
    })

    sota.stackedColumnChart({
        selector: "#module-politics-affirmative_actionXrace-d3",
        dataFile: "assets/data/politics/affirmative_actionXrace"
    })

    sota.stackedColumnChart({
        selector: "#module-politics-reverse_racismXclass-d3",
        dataFile: "assets/data/politics/reverse_racismXclass"
    })

    sota.stackedBarChart({
        selector: "#module-politics-womens_rightsXfeminist-d3",
    ...
    sota.stackedBarChart({
        selector: "#module-politics-feministXgender-d3",
    ...
    sota.stackedColumnChart({
        selector: "#module-politics-abortionXgender-d3",
        dataFile: "assets/data/politics/abortionXgender"
    })

    sota.stackedBarChart({
        selector: "#module-politics-prison_reformXincarceration-d3",
    ...
    sota.stackedColumnChart({
        selector: "#module-politics-firearmsXcommunity-d3",
...
// SCHOOL
    ...
    sota.stackedBarChart({
        selector: "#module-school-stem_humanitiesXgender-d3",
        dataFile: "assets/data/school/stem_humanitiesXgender",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: true
    });
    ...
    sota.stackedColumnChart({
        selector: "#module-school-hours_on_courseworkXgender-d3",
    ...
    sota.stackedBarChart({
        selector: "#module-school-leaving-d3",
    ...
    sota.stackedBarChart({
        selector: "#module-school-family_relationship-d3",
    ...
    sota.stackedBarChart({
        selector: "#module-school-characterXtemperament-d3",
    ...
    sota.stackedBarChart({
        selector: "#module-school-children-d3",
    ...
    sota.stackedBarChart({
        selector: "#module-school-childrenXclass-d3",
    ...
    sota.stackedColumnChart({
        selector: "#module-school-collegeXincome-d3",
        dataFile: "assets/data/school/collegeXincome"
    });

    sota.stackedColumnChart({
        selector: "#module-school-collegeXclass-d3",
        dataFile: "assets/data/school/collegeXclass"
    });

    sota.stackedColumnChart({
        selector: "#module-school-collegeXlocation-d3",
        dataFile: "assets/data/school/collegeXlocation"
    });

    sota.stackedBarChart({
        selector: "#module-school-learning_disabilityXaccomodation-d3",
    ...
    sota.stackedColumnChart({
        ...
        dataFile: "assets/data/school/student_leaderXtemperament"
    });

// DISCIPLINE
    sota.barChart({
        selector: "#module-discipline-understand_processes-d3",
    ...
    sota.stackedBarChart({
        selector: "#module-discipline-understand_processesXboarding-d3",
        dataFile: "assets/data/discipline/understand_processesXboarding",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: true
    });
    ...
    sota.stackedBarChart({
        selector: "#module-discipline-effectiveXDC-d3",
    ...
    sota.stackedBarChart({
        selector: "#module-discipline-major_offensesXboarding-d3",
    ...
    sota.stackedBarChart({
        selector: "#module-discipline-favors_privileged-d3",
        dataFile: "assets/data/discipline/favors_privileged",
        labelStyle: "onBar",
        showLegend: true
    });

    sota.stackedBarChart({
        selector: "#module-discipline-favors_privilegedXincome-d3",
    ...
    sota.stackedBarChart({
        selector: "#module-discipline-favors_privilegedXclass-d3",
...
// SEX
    sota.groupedBarChart({
        selector: "#module-sex-sexXclass-d3",
        dataFile: "assets/data/sex/sexXclass",
        totalResp: {2023: 216, 2022: 271, 2021: 271, 2020: 267},
        showLegend: true
    })

    sota.stackedBarChart({
        selector: "#module-sex-frequency-d3",
        dataFile: "assets/data/sex/frequency",
        labelStyle: "onBar",
        showLegend: true
    });

    sota.barChart({
        selector: "#module-sex-number_of_partners-d3",
    ...
    sota.stackedBarChart({
        selector: "#module-sex-verbal_consent-d3",
        dataFile: "assets/data/sex/verbal_consent",
        labelStyle: "onBar",
        showLegend: true
    });
    ...
    sota.stackedBarChart({
        ...
        dataFile: "assets/data/sex/relationshipXclass",
        labelStyle: "onBar",
        showLegend: true
    });

    sota.stackedColumnChart({
        selector: "#module-sex-relationship_classXclass-d3",
        dataFile: "assets/data/sex/relationship_classXclass"
    });

    sota.lineGraph({
        selector: "#module-sex-sex_ed2015-d3",
        dataFile: "assets/data/sex/sex_ed2015",
        inputIsPercentage: true
    })

    sota.stackedBarChart({
        selector: "#module-sex-masturbationXgender-d3",
        dataFile: "assets/data/sex/masturbationXgender",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: true
    });
    ...
    sota.stackedBarChart({
        selector: "#module-sex-masturbation_tellXgender-d3",
        dataFile: "assets/data/sex/masturbation_tellXgender",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: true
    });
    ...
    sota.stackedBarChart({
        selector: "#module-sex-pornXfeminist-d3",
        dataFile: "assets/data/sex/pornXfeminist",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: true
    });
    ...
    sota.stackedBarChart({
        selector: "#module-sex-harassmentXgender-d3",
        dataFile: "assets/data/sex/harassmentXgender",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: true
    });
...
// inputIsPercentage error
    ...
    sota.stackedBarChart({
        selector: "#module-sex-assaultXgender-d3",
        dataFile: "assets/data/sex/assaultXgender",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: true
    });
...
// DRUGS AND ALCOHOL
    sota.stackedBarChart({
        selector: "#module-drugs-alcoholXclass-d3",
        dataFile: "assets/data/drugs-alcohol/alcoholXclass",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: true
    });
    ...
    sota.stackedBarChart({
        selector: "#module-drugs-tobaccoXclass-d3",
    ...
    sota.stackedBarChart({
        selector: "#module-drugs-juulXclass-d3",
    ...
    sota.stackedBarChart({
        selector: "#module-drugs-marijuanaXclass-d3",
    ...
    sota.stackedColumnChart({
        selector: "#module-drugs-dorm_influenceXcluster-d3",
        dataFile: "assets/data/drugs-alcohol/dorm_influenceXcluster"
    });

    sota.stackedBarChart({
        selector: "#module-drugs-drug_frequency-d3",
        dataFile: "assets/data/drugs-alcohol/drug_frequency",
        labelStyle: "onBar",
        showLegend: true
    });
    ...
    sota.stackedBarChart({
        ...
        dataFile: "assets/data/drugs-alcohol/juulXincome",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: true
    });
    ...
    sota.stackedColumnChart({
        selector: "#module-drugs-normalizedXconsumption-d3",
    ...
    sota.barChart({
        ...
        dataFile: "assets/data/drugs-alcohol/hard_drugs",
        totalResp: 1014,
        displayPercentage: true
    });

    sota.stackedBarChart({
        selector: "#module-drugs-drugs_stress-d3",
        dataFile: "assets/data/drugs-alcohol/drugs_stress",
        labelStyle: "onBar",
        showLegend: true
    });

    sota.stackedBarChart({
        selector: "#module-drugs-peer_pressure-d3",
        dataFile: "assets/data/drugs-alcohol/peer_pressure",
        labelStyle: "onBar",
        showLegend: true
    });
    ...
    sota.stackedBarChart({
        ...
        dataFile: "assets/data/drugs-alcohol/fake_id",
        labelStyle: "onBar",
        showLegend: true
    });

    sota.stackedBarChart({
        selector: "#module-drugs-sanctuary-d3",
        dataFile: "assets/data/drugs-alcohol/sanctuary",
        labelStyle: "onBar",
        showLegend: true
    });
...
// WELLNESS
    ...
    sota.barChart({
        selector: "#module-wellness-had-d3",
        dataFile: "assets/data/wellness/had",
        totalResp: 1034,
        displayPercentage: true
    });

    sota.stackedBarChart({
        selector: "#module-wellness-anxietyXgender-d3",
    ...
    sota.stackedColumnChart({
        selector: "#module-wellness-insecureXsocial_media-d3",
        dataFile: "assets/data/wellness/insecureXsocial_media"
    });

    sota.stackedBarChart({
        selector: "#module-wellness-insecureXgender-d3",
    ...
    sota.stackedBarChart({
        ...
        dataFile: "assets/data/wellness/counselorXgender",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: true
    });
    ...
    sota.stackedBarChart({
        selector: "#module-wellness-sykes_resourcesXcounselor-d3",
        dataFile: "assets/data/wellness/sykes_resourcesXcounselor",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: true
    });
    ...
    sota.pieChart({
        selector: "#module-wellness-support_system_adequacy-d3",
        dataFile: "assets/data/wellness/support_system_adequacy"
    });

    sota.stackedBarChart({
        selector: "#module-wellness-social_media_effect-d3",
        dataFile: "assets/data/wellness/social_media_effect",
        labelStyle: "onBar",
        showLegend: true
    });
    ...
    sota.stackedBarChart({
        selector: "#module-wellness-happinessXretrospect-d3",
        dataFile: "assets/data/wellness/happinessXretrospect",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: true
    });
    ...
    sota.stackedColumnChart({
        selector: "#module-wellness-happinessXclass-d3",
        dataFile: "assets/data/wellness/happinessXclass"
    });

    sota.stackedColumnChart({
        selector: "#module-wellness-happinessXtemperament-d3",
    ...
    sota.stackedBarChart({
        selector: "#module-wellness-commons_limitXdietary_restrictions-d3",
        dataFile: "assets/data/wellness/commons_limitXdietary_restrictions",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: true
    });
...
// COVID-19
    ...
    sota.stackedBarChart({
        selector: "#module-covid-quiet_spacesXincome-d3",
        dataFile: "assets/data/covid/quiet_spacesXincome",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: true
    });
    ...
    sota.barChart({
        selector: "#module-covid-time_zones-d3",
        dataFile: "assets/data/covid/time_zones",
        totalResp: 1023,
        displayPercentage: true
    });

    sota.stackedBarChart({
        selector: "#module-covid-remote_learning-d3",
        dataFile: "assets/data/covid/remote_learning",
        labelStyle: "onBar",
        showLegend: true
    });
    ...
    sota.stackedBarChart({
        ...
        dataFile: "assets/data/covid/andover_response",
        labelStyle: "onBar",
        showLegend: true
    });

    sota.stackedBarChart({
        selector: "#module-covid-us_responseXpolitics-d3",
    ...
    sota.stackedBarChart({
        ...
        dataFile: "assets/data/covid/vacationXincome",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: true
    });
...
// COMMUNITY
    ...
    sota.barChart({
        selector: "#module-community-faculty_diversity-d3",
    ...
    sota.barChart({
        selector: "#module-community-faculty_support-d3",
    ...
    sota.barChart({
        selector: "#module-community-social_divide-d3",
    ...
    sota.barChart({
        selector: "#module-community-leadership-d3",
    ...
    sota.barChart({
        selector: "#module-community-discrimination-d3",
    ...
    sota.barChart({
        selector: "#module-community-classroom_comfort-d3",
    ...
    sota.barChart({
        selector: "#module-community-identity_discussion-d3",
    ...
    sota.stackedBarChart({
        selector: "#module-community-faculty_diversityXgender-d3",
    ...
    sota.stackedBarChart({
        selector: "#module-community-social_divideXclass-d3",
    ...
    sota.stackedBarChart({
        selector: "#module-community-leadershipXgender-d3",
        dataFile: "assets/data/community/leadershipXgender",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: true
    });
    ...
    sota.stackedBarChart({
        selector: "#module-community-leadershipXrace-d3",
        dataFile: "assets/data/community/leadershipXrace",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: false
    });
    ...
    sota.stackedBarChart({
        selector: "#module-community-leadershipXstatus-d3",
        dataFile: "assets/data/community/leadershipXstatus",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: false
    });
    ...
    sota.stackedBarChart({
        selector: "#module-community-classroom_comfortXgender-d3",
        dataFile: "assets/data/community/classroom_comfortXgender",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: true
    });
    ...
    sota.stackedBarChart({
        selector: "#module-community-classroom_comfortXethnicity-d3",
        dataFile: "assets/data/community/classroom_comfortXethnicity",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: false
    });
...
// sota.pieChart({ selector: "#module-community-ebi-d3", dataFile: "assets/data/community/ebi", inputIsPercentage: true });
    ...
    sota.stackedBarChart({
        ...
        dataFile: "assets/data/community/ebiXclass",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: true
    });
    ...
    sota.stackedColumnChart({
        selector: "#module-community-day_supportXboarding-d3",
        dataFile: "assets/data/community/day_supportXboarding"
    });
...
sota.barChart({ selector: "#module-community-camdXrace-d3", dataFile: "assets/data/community/camdXrace", displayPercentage:true, inputIsPercentage: true });

sota.barChart({ selector: "#module-community-camdXpolitics-d3", dataFile: "assets/data/community/camdXpolitics", displayPercentage:true, inputIsPercentage: true });

sota.barChart({ selector: "#module-community-silentXrace-d3", dataFile: "assets/data/community/silentXrace", displayPercentage:true, inputIsPercentage: true });

sota.barChart({ selector: "#module-community-lower_rightXrace-d3", dataFile: "assets/data/community/lower_rightXrace", displayPercentage: true, inputIsPercentage: true });

sota.barChart({ selector: "#module-community-lower_rightXvarsity-d3", dataFile: "assets/data/community/lower_rightXvarsity", displayPercentage:true, inputIsPercentage: true });

    sota.pieChart({selector: "#module-community-language-d3", dataFile: "assets/data/community/language"});

    sota.stackedBarChart({
        selector: "#module-community-languageXrace-d3",
        dataFile: "assets/data/community/languageXrace",
        labelStyle: "onBar",
        groupLabelStyle: "onBar",
        showLegend: true
    });
